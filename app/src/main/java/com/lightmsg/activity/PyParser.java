...
public class PyParser {
    private static int[] specialPyValue = new int[] {-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    public static String[] specialPyStr = new String[] {"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    private static PyParser pyParser = new PyParser();

    private PyParser() {
    }
    
    public static PyParser getInstance() {
        return pyParser;
    }

    /** @param ch A single charactor @return */
    private int getChAscii(String ch) {
        int asc = 0;
        try {
    ...
    /** @param str A single charactor * @return */
    public String convert(String str) {
        String result = null;
        int ascii = getChAscii(str);
        if (ascii > 0 && ascii < 160) {
            result = String.valueOf((char) ascii);
        } else {
            for (int i = (specialPyValue.length - 1); i >= 0; i--) {
                if (specialPyValue[i] <= ascii) {
                    result = specialPyStr[i];
                    break;
                }
            }
        }
    ...
    /** Parse the whole string **@param chs The whole string ** @return */

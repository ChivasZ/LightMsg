...
public class AccountRegister extends Activity {
    ...
    private static final String TAG = "LightMsg/" + AccountRegister.class.getSimpleName();
    ...
    private View.OnClickListener btnRegisterListener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            editor.putString("username", accountUsername);
            ...
            if (xs != null) {
                ...
                bundle.putString("user", accountUsername);

package com.lightmsg.activity.msg.etc;
...
public class LoginUsers extends Activity implements OnGestureListener{

    private static final String TAG = "LightMsg/" + LoginUsers.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //startRosterListActivity(this.getApplicationContext());

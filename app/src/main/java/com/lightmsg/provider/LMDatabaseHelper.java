...
public class LMDatabaseHelper extends SQLiteOpenHelper {
    private static final String TAG = LMDatabaseHelper.class.getSimpleName();
    private static LMDatabaseHelper sInstance = null;
    ...
    static synchronized LMDatabaseHelper getInstance(Context context) {
        Log.d(TAG, "getInstance()...");
        if (sInstance == null) {
            sInstance = new LMDatabaseHelper(context);
        }
        return sInstance;
    }

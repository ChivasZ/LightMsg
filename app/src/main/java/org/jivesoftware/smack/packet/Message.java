...
public class Message extends Packet {
    ...
    private FileMethod file_method = FileMethod.upload;
    ...
    /**
     * Sets the file-method of the message.
     *
     * @param fm the file of the message.
     */
     ...
     * Sets the file-method of the message.
     *
     * @return the file-method of the message.
     */
    ...
    public String toXML() {
        ...
        if (type == Type.file) {
            buf.append(" file-method=\"").append(file_method).append("\"");
        }
        buf.append(">");
        ...
        if (type == Type.file && file != null) {
			...
			buf.append(" hash=\"");
			buf.append(file.getHash());
			buf.append("\"");
			
			buf.append(" content-type=\"");
			buf.append(file.getType());
			buf.append("\" />");
        }
